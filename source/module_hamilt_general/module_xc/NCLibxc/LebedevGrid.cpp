// Programmed by Xiaoyu Zhang at Peking University, Beijing, China 2024/08/24

//Reference:[1] V.I. Lebedev, and D.N. Laikov
//        "A quadrature formula for the sphere of the 131st
//         algebraic order of accuracy"
//         Doklady Mathematics, Vol. 59, No. 3, 1999, pp. 477-481.

//Independent test is at the bottom of this file

//Input: grids.level Output: grids(x,y,z,weight)；spherical_coords(theta,phi,weight)
...
//int grid_level = nums[30]; // Set the grid level， count from 0th
//std::vector<std::array<double, 4>> grids = MakeAngularGrid(grid_level);
//auto spherical_coords = ConvertToSpherical(grids);
...
std::vector<std::array<double, 4>> MakeAngularGrid_6() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.1666666666666667e+0;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
    return grids;
}

std::vector<std::array<double, 4>> MakeAngularGrid_14() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.6666666666666667e-1;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
    v = 0.7500000000000000e-1;
    g = SphGenOh(2, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
    return grids;
}

std::vector<std::array<double, 4>> MakeAngularGrid_26() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.4761904761904762e-1;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
    v = 0.3809523809523810e-1;
    g = SphGenOh(1, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
    v = 0.3214285714285714e-1;
    // g = SphGenOh(3, a, b, v); // SphGenOh returns a vector
    g = SphGenOh(2, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
    return grids;
}

std::vector<std::array<double, 4>> MakeAngularGrid_38() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.9523809523809524e-2;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
    ...
    g = SphGenOh(4, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());

    // v = 0.2380952380952381e-1;
    // g = SphGenOh(3, a, b, v); // SphGenOh returns a vector
    // grids.insert(grids.end(), g.begin(), g.end());
    return grids;
}

std::vector<std::array<double, 4>> MakeAngularGrid_50() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.1269841269841270e-1;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_74() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.5130671797338464e-3;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_86() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.1154401154401154e-1;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_110() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.3828270494937162e-2;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_146() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.5996313688621381e-3;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
    ...
    g = SphGenOh(5, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
    return grids;
}

std::vector<std::array<double, 4>> MakeAngularGrid_170() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0,  v = 0.5544842902037365e-2;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_194() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.1782340447244611e-2;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_230() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = -0.5522639919727325e-1;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_266() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = -0.1313769127326952e-2;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_302() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.8545911725128148e-3;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_350() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.3006796749453936e-2;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_434() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.5265897968224436e-3;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_590() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.3095121295306187e-3;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_770() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.2192942088181184e-3;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_974() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.1438294190527431e-3;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_1202() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.1105189233267572e-3;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_1454() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.7777160743261247e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_1730() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.6309049437420976e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_2030() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.4656031899197431e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_2354() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.3922616270665292e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_2702() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.2998675149888161e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_3074() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.2599095953754734e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_3470() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.2040382730826330e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_3890() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.1807395252196920e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_4334() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.1449063022537883e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_4802() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.9687521879420705e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_5294() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.9080510764308163e-4;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_5810() {
    std::vector<std::array<double, 4>> grids;
    double a = 0, b = 0, v = 0.9735347946175486e-5;
    auto g = SphGenOh(0, a, b, v); // SphGenOh returns a vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid(int grid_level) {
    switch (grid_level) {
        case 6:
            return MakeAngularGrid_6();
        case 14:
            return MakeAngularGrid_14();
        case 26:
            return MakeAngularGrid_26();
        case 38:
            return MakeAngularGrid_38();
        case 50:
            return MakeAngularGrid_50();
        case 74:
            return MakeAngularGrid_74();
        case 86:
            return MakeAngularGrid_86();
        case 110:
            return MakeAngularGrid_110();
        case 146:
            return MakeAngularGrid_146();
        case 170:
            return MakeAngularGrid_170();
        case 194:
            return MakeAngularGrid_194();
        case 230:
            return MakeAngularGrid_230();
        case 266:
            return MakeAngularGrid_266();
        case 302:
            return MakeAngularGrid_302();
        case 350:
            return MakeAngularGrid_350();
        case 434:
            return MakeAngularGrid_434();
        case 590:
            return MakeAngularGrid_590();
        case 770:
            return MakeAngularGrid_770();
        case 974:
            return MakeAngularGrid_974();
        case 1202:
            return MakeAngularGrid_1202();
        case 1454:
            return MakeAngularGrid_1454();
        case 1730:
            return MakeAngularGrid_1730();
        case 2030:
            return MakeAngularGrid_2030();
        case 2354:
            return MakeAngularGrid_2354();
        case 2702:
            return MakeAngularGrid_2702();
        case 3074:
            return MakeAngularGrid_3074();
        case 3470:
            return MakeAngularGrid_3470();
        case 3890:
            return MakeAngularGrid_3890();
        case 4334:
            return MakeAngularGrid_4334();
        case 4802:
            return MakeAngularGrid_4802();
        case 5294:
            return MakeAngularGrid_5294();
        case 5810:
            return MakeAngularGrid_5810();
        default:
            std::cerr << "Invalid grid level!" << std::endl;
            return {};
    }
}

// Function to convert Cartesian coordinates to spherical coordinates
std::vector<std::array<double, 3>> ConvertToSpherical(const std::vector<std::array<double, 4>>& grids) {
    std::vector<std::array<double, 3>> spherical_coords;
    for (const auto& grid : grids) {
        double x = grid[0];
        double y = grid[1];
        double z = grid[2];
        double r = std::sqrt(x * x + y * y + z * z);
        double theta = std::acos(z / r); // theta is the polar angle， range [0, pi]
        double phi = std::atan2(y, x); // phi is the azimuthal angle， range [0, 2pi]
        spherical_coords.push_back({theta, phi, grid[3]}); // Keep the weight as is
    }
...
int main() {
    ...
    int grid_level = nums[0]; // Set the grid level， count from 0th
    std::vector<std::array<double, 4>> grids = MakeAngularGrid(grid_level);

    auto spherical_coords = ConvertToSpherical(grids);

    for (const auto& coord : spherical_coords) {
        std::cout << "Theta: " << coord[0] << ", Phi: " << coord[1] << ", Weight: " << coord[2] << std::endl;
    }
    ...
    std::cout << "### point = " << grid_level << ", ####################################\n" << std::endl;

    int count = 0;
    for (const auto & grid_level : nums)
    {        
        std::vector<std::array<double, 4>> grids = MakeAngularGrid(grid_level);
        ...
        for (const auto& grid : grids) {
            for (const auto& value : grid) {
                total_sum += value;  // 累加每个元素
            }
        }

        std::cout << "num "<< ++count << ", point = " << grid_level << " Total sum: " << total_sum << std::endl;
